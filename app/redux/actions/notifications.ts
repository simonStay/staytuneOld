...
export function getPlaceInfo(placeId) {
    return async dispatch => {
        ...
        const res = await fetch('https://maps.googleapis.com/maps/api/place/details/json?key=' + GOOGLE_API_KEY + '&placeid=' + placeId)
...
export function notificationList(userId) {
    ...
    return async dispatch => {
        ...
        const res = await fetch('https://staytune.austinconversionoptimization.com/notificationslist', {
            method: "POST",
            headers: {
